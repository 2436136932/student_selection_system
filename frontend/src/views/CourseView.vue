<template>
  <div class="course-container">
    ...
    <!-- 专业管理卡片 -->
    <el-card shadow="hover" v-if="hasRole('admin')">
      <template #header>
        <div class="card-header">
          <span>专业管理</span>
          <div style="display: flex; gap: 10px;">
            ...
            <el-button size="small" type="primary" @click="showAddMajorDialog">
              添加专业
            </el-button>
          </div>
        </div>
      ...
      <div class="card-body">
        <el-table :data="currentMajors" style="width: 100%" stripe>
          ...
          <el-table-column label="操作" width="250" fixed="right">
            <template #default="scope">
              <el-button size="small" type="primary" @click="showDepartmentAssignmentDialog(scope.row)" style="margin-right: 10px;">
                分配院系
              </el-button>
              <el-button size="small" type="danger" @click="handleDeleteMajor(scope.row)">
                删除
              </el-button>
            </template>
          </el-table-column>
