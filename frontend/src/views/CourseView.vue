<template>
  <div class="course-container">
    ...
    <!-- 课程气泡卡片 -->
    <el-card class="course-bubble-card">
      <template #header>
        <div class="card-header">
          <span>已添加的课程</span>
        </div>
          ...
          <template #header>
            <div class="bubble-header">
              ...
              <el-tag :type="course.status === 1 ? 'success' : 'info'" size="small">
                {{ course.status === 1 ? '开放' : '关闭' }}
              </el-tag>
            </div>
          </template>
          <div class="bubble-content">
            <div class="bubble-item">
              <span class="bubble-label">课程名称：</span>
              <span class="bubble-value">{{ course.courseName }}</span>
            </div>
            <div class="bubble-item">
              <span class="bubble-label">学分：</span>
              <span class="bubble-value">{{ course.credits }}</span>
            </div>
            <div class="bubble-item">
              <span class="bubble-label">学时：</span>
              <span class="bubble-value">{{ course.hours }}</span>
            </div>
            <div class="bubble-item">
              <span class="bubble-label">授课老师：</span>
              <span class="bubble-value">{{ course.teacherName || '未分配' }}</span>
            </div>
            <div class="bubble-item">
              <span class="bubble-label">学期：</span>
              <span class="bubble-value">{{ course.semester }}</span>
            </div>
            <div class="bubble-item">
              <span class="bubble-label">选课情况：</span>
              <span class="bubble-value">{{ course.currentStudents }}/{{ course.maxStudents }}</span>
            </div>
            <div class="bubble-description">
              <span class="bubble-label">课程描述：</span>
              <span class="bubble-value">{{ course.description || '暂无描述' }}</span>
            </div>
          </div>
          <template #footer>
